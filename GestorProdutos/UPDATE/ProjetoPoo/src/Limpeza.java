...
public class Limpeza extends Produtos{
    ...
    public Limpeza( int identificador,int toxicidade, String nome,float precoUnitario,ArrayList<Promocoes> promocao,int stock) throws InputMismatchException {
    ...
    public String toString() {
        return getNome()+" preco:"+ getPrecoUnitario()+"   caracteristicas: Taxa de toxicicade:"+toxicidade;
    }
