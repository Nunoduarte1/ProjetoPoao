...
public class Alimentares extends Produtos{
     ...
     *
     */
    public Alimentares(int identificador,int calorias, int percentagemGordura,  String nome, ArrayList<Promocoes> promocao ,float precoUnitario, int stock) throws InputMismatchException {
    ...
    public String toString() {
        return getNome()+" preco:"+ getPrecoUnitario()+"   caracteristicas: calorias:"+calorias+" por cada 100g, Percentagem de gordura:"+percentagemGordura+"%";
    }
